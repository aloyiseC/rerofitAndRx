...
public class UserEncryptUtil {
    ...
    private static String getKeyStringOld(Context context) {
        final String key1 = "android";
        final String key2 = " and ";
        final String key3 = "iphone";

        String key = "tianya" + key1 + key2 + key3;
        return key;
    }
...
*/
    /*
     * @Deprecated public static byte[] encryptUserOld(Context context,User
     * user) throws JSONException{ String json = JSONUtil.toJsonString(user); if
     * (json == null) { return null; } byte[] datas =
     * CompressEncrypt.encryptObject(getKeyString(context), json); return datas;
     * }
     */
